...
from plotmanager.library.utilities.commands import start_manager, stop_manager, view, json_output, analyze_logs, show_running_plots
...
if args.action == 'start':
    ...
    analyze_logs()
elif args.action == 'show_running_plots':
    show_running_plots()
else:
